# -*- coding: utf-8 -*-
"""
Created on Mon Jan 29 16:43:54 2024
...
SalaryData_Train = pd.read_csv('c:/2-dataset/SalaryData_Train.csv')
...
# Load the test data
SalaryData_Test = pd.read_csv('c:/2-dataset/SalaryData_Test.csv')
